...
public class Chords3button extends Activity {
...
//	    --------------------------Bluetooth-----------------------------
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chords3button);
		...
		findViewById(R.id.C).setOnTouchListener(new ButtonTouchListner(-1, 3, 2, -1, 1, -1, chord)); 
	    findViewById(R.id.Cm).setOnTouchListener(new ButtonTouchListner(3, 3, 5, 5, 4, -1, chord));
	    findViewById(R.id.C7).setOnTouchListener(new ButtonTouchListner(-1, 3, 2, 3, 1, -1, chord));
	    findViewById(R.id.CM7).setOnTouchListener(new ButtonTouchListner(-1, 3, 2, -1, -1, -1, chord));
	    findViewById(R.id.Cm7).setOnTouchListener(new ButtonTouchListner(3, 3, 5, 3, 4, 3, chord));
	    
		
	    findViewById(R.id.D).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 2, 3, 2, chord));
	    findViewById(R.id.Dm).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 2, 3, 1, chord));
	    findViewById(R.id.D7).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 2, 1, 2, chord));
	    findViewById(R.id.DM7).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 2, 2, 2, chord));
	    findViewById(R.id.Dm7).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 2, 1, 1, chord));

		
	    findViewById(R.id.E).setOnTouchListener(new ButtonTouchListner(-1, 2, 2, 1, -1, -1, chord));
	    findViewById(R.id.Em).setOnTouchListener(new ButtonTouchListner(-1, 2, 2, -1, -1, -1, chord));
	    findViewById(R.id.E7).setOnTouchListener(new ButtonTouchListner(-1, 2, -1, 1, -1, -1, chord));
	    findViewById(R.id.EM7).setOnTouchListener(new ButtonTouchListner(-1, 2, 1, 1, -1, -1, chord));
	    findViewById(R.id.Em7).setOnTouchListener(new ButtonTouchListner(-1, 2, -1, -1, -1, -1, chord));

		
	    findViewById(R.id.F).setOnTouchListener(new ButtonTouchListner(1, 3, 3, 2, 1, 1, chord));
	    findViewById(R.id.Fm).setOnTouchListener(new ButtonTouchListner(1, 3, 3, 1, 1, 1, chord));
	    findViewById(R.id.F7).setOnTouchListener(new ButtonTouchListner(1, 3, 1, 2, 1, 1, chord));
	    findViewById(R.id.FM7).setOnTouchListener(new ButtonTouchListner(-1, -1, 3, 2, 1, -1, chord));
	    findViewById(R.id.Fm7).setOnTouchListener(new ButtonTouchListner(1, 3, 1, 1, 1, 1, chord));
	
		
	    findViewById(R.id.G).setOnTouchListener(new ButtonTouchListner(3, 2, -1, -1, -1, 3, chord));
	    findViewById(R.id.Gm).setOnTouchListener(new ButtonTouchListner(3, 5, 5, 3, 3, 3, chord));
	    findViewById(R.id.G7).setOnTouchListener(new ButtonTouchListner(3, 2, -1, -1, -1, -1, chord));
	    findViewById(R.id.GM7).setOnTouchListener(new ButtonTouchListner(3, 2, -1, -1, -1, 2, chord));
	    findViewById(R.id.Gm7).setOnTouchListener(new ButtonTouchListner(3, 5, 3, 3, 3, 3, chord));
	   
		
	    findViewById(R.id.A).setOnTouchListener(new ButtonTouchListner(-1, -1, 2, 2, 2, -1, chord));
	    findViewById(R.id.Am).setOnTouchListener(new ButtonTouchListner(-1, -1, 2, 2, 1, -1, chord));
	    findViewById(R.id.A7).setOnTouchListener(new ButtonTouchListner(-1, -1, 2, -1, 2, -1, chord));
	    findViewById(R.id.AM7).setOnTouchListener(new ButtonTouchListner(-1, -1, 2, 1, 2, -1, chord));
	    findViewById(R.id.Am7).setOnTouchListener(new ButtonTouchListner(-1, -1, 2, -1, 1, -1, chord));
	  
	    
	    findViewById(R.id.B).setOnTouchListener(new ButtonTouchListner(1, 1, 3, 3, 3, 1, chord));
	    findViewById(R.id.Bm).setOnTouchListener(new ButtonTouchListner(1, 1, 3, 3, 2, 1, chord));
	    findViewById(R.id.B7).setOnTouchListener(new ButtonTouchListner(-1, 2, 1, 2, -1, 2, chord));
	    findViewById(R.id.BM7).setOnTouchListener(new ButtonTouchListner(1, 1, 3, 2, 3, 1, chord));
	    findViewById(R.id.Bm7).setOnTouchListener(new ButtonTouchListner(1, 1, 3, 1, 2, 1, chord));
	  
	    
	    mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
	    mConversationArrayAdapter = new ArrayAdapter<String>(this, R.layout.message);
	    mConversationView = (ListView) findViewById(R.id.in8);
