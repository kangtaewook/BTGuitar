...
//-----------------------------------------------2 번 째 줄--------------------------------------------------------------------------------------------------//					
				...
				if(chord.getChord()[1]==1){//2번째 플랫 1번줄				    
							sendMessage(chord);
							try {
								Thread.sleep(200);
							} catch (InterruptedException e) {
				...
				if(chord.getChord()[1]==2){//2번째 플랫 2번줄				
					sendMessage(chord);						
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[1]==3){//2번째 플랫 3번줄						
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[1]==4){//2번째 플랫 4번줄					
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[1]==5){//2번째 플랫 5번줄						
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[1]==6){//2번째 플랫 6번줄
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------//
				//-----------------------------------------------------3 번 째 플 렛 -----------------------------------------------------------------------//					
				if(chord.getChord()[2]==1){//3번째 플랫 1번줄			    
							sendMessage(chord);
							try {
								Thread.sleep(200);
							} catch (InterruptedException e) {
				...
				if(chord.getChord()[2]==2){//3번째 플랫 2번줄					
					sendMessage(chord);					
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[2]==3){//3번째 플랫 3번줄						
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[2]==4){//3번째 플랫 4번줄					
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[2]==5){//3번째 플랫 5번줄					
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
				...
				if(chord.getChord()[2]==6){//3번째 플랫 6번줄					
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
...
//-----------------------------------------------4 번 째 플 렛--------------------------------------------------------------------------------------------------//					
			...
			if(chord.getChord()[3]==1){//4번째 플랫 1번줄		    
						sendMessage(chord);
						try {
							Thread.sleep(200);
						} catch (InterruptedException e) {
			...
			if(chord.getChord()[3]==2){//4번째 플랫 2번줄			
				sendMessage(chord);				
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[3]==3){//4번째 플랫 3번줄				
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[3]==4){//4번째 플랫 4번줄				
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[3]==5){//4번째 플랫 5번줄				
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[3]==6){//4번째 플랫 6번줄				
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------//				
			//-----------------------------------------------------5 번 째 플 렛 -----------------------------------------------------------------------//					
			if(chord.getChord()[4]==1){//5번째 플랫 1번줄			    
						sendMessage(chord);
						try {
							Thread.sleep(200);
						} catch (InterruptedException e) {
			...
			if(chord.getChord()[4]==2){//5번째 플랫 2번줄				
				sendMessage(chord);					
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[4]==3){//5번째 플랫 3번줄				
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[4]==4){//5번째 플랫 4번줄					
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[4]==5){//5번째 플랫 5번줄					
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
			...
			if(chord.getChord()[4]==6){//5번째 플랫 6번줄					
				sendMessage(chord);
				try {
					Thread.sleep(200);
				} catch (InterruptedException e) {
...
//-----------------------------------------------6 번 째 플 렛--------------------------------------------------------------------------------------------------//					
		...
		if(chord.getChord()[5]==1){//6번째 플랫 1번줄		    
					sendMessage(chord);
					try {
						Thread.sleep(200);
					} catch (InterruptedException e) {
		...
		if(chord.getChord()[5]==2){//6번째 플랫 2번줄			
			sendMessage(chord);				
			try {
				Thread.sleep(200);
			} catch (InterruptedException e) {
		...
		if(chord.getChord()[5]==3){//6번째 플랫 3번줄				
			sendMessage(chord);
			try {
				Thread.sleep(200);
			} catch (InterruptedException e) {
		...
		if(chord.getChord()[5]==4){//6번째 플랫 4번줄			
			sendMessage(chord);
			try {
				Thread.sleep(200);
			} catch (InterruptedException e) {
		...
		if(chord.getChord()[5]==5){//6번째 플랫 5번줄			
			sendMessage(chord);
			try {
				Thread.sleep(200);
			} catch (InterruptedException e) {
		...
		if(chord.getChord()[5]==6){//6번째 플랫 6번줄
			sendMessage(chord);
			try {
				Thread.sleep(200);
			} catch (InterruptedException e) {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------//
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//chordname = new Chordname();
		//chordname.initChordname();
		...
		findViewById(R.id.imageButton_1_1).setOnTouchListener(new ButtonTouchListner(1, -1, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_1_2).setOnTouchListener(new ButtonTouchListner(-1, 1, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_1_3).setOnTouchListener(new ButtonTouchListner(-1, -1, 1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_1_4).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 1, -1, -1, chord));
        findViewById(R.id.imageButton_1_5).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, 1, -1, chord));
        findViewById(R.id.imageButton_1_6).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, -1, 1, chord));
		
        findViewById(R.id.imageButton_2_1).setOnTouchListener(new ButtonTouchListner(2, -1, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_2_2).setOnTouchListener(new ButtonTouchListner(-1, 2, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_2_3).setOnTouchListener(new ButtonTouchListner(-1, -1, 2, -1, -1, -1, chord));
        findViewById(R.id.imageButton_2_4).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 2, -1, -1, chord));
        findViewById(R.id.imageButton_2_5).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, 2, -1, chord));
        findViewById(R.id.imageButton_2_6).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, -1, 2, chord));
		
        findViewById(R.id.imageButton_3_1).setOnTouchListener(new ButtonTouchListner(3, -1, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_3_2).setOnTouchListener(new ButtonTouchListner(-1, 3, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_3_3).setOnTouchListener(new ButtonTouchListner(-1, -1, 3, -1, -1, -1, chord));
        findViewById(R.id.imageButton_3_4).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 3, -1, -1, chord));
        findViewById(R.id.imageButton_3_5).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, 3, -1, chord));
        findViewById(R.id.imageButton_3_6).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, -1, 3, chord));
		
        findViewById(R.id.imageButton_4_1).setOnTouchListener(new ButtonTouchListner(4, -1, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_4_2).setOnTouchListener(new ButtonTouchListner(-1, 4, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_4_3).setOnTouchListener(new ButtonTouchListner(-1, -1, 4, -1, -1, -1, chord));
        findViewById(R.id.imageButton_4_4).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 4, -1, -1, chord));
        findViewById(R.id.imageButton_4_5).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, 4, -1, chord));
        findViewById(R.id.imageButton_4_6).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, -1, 4, chord));
		
        findViewById(R.id.imageButton_5_1).setOnTouchListener(new ButtonTouchListner(5, -1, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_5_2).setOnTouchListener(new ButtonTouchListner(-1, 5, -1, -1, -1, -1, chord));
        findViewById(R.id.imageButton_5_3).setOnTouchListener(new ButtonTouchListner(-1, -1, 5, -1, -1, -1, chord));
        findViewById(R.id.imageButton_5_4).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, 5, -1, -1, chord));
        findViewById(R.id.imageButton_5_5).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, 5, -1, chord));
        findViewById(R.id.imageButton_5_6).setOnTouchListener(new ButtonTouchListner(-1, -1, -1, -1, -1, 5, chord));
        
        findViewById(R.id.F).setOnTouchListener(new ButtonTouchListner(1, 3, 3, 2, 1, 1, chord));
        findViewById(R.id.Gsus4).setOnTouchListener(new ButtonTouchListner(-1, 2, -1, -1, 3, 3, chord));
        findViewById(R.id.G7sus4).setOnTouchListener(new ButtonTouchListner(3, -1, 3, -1, 1, -1, chord));
        findViewById(R.id.FM7).setOnTouchListener(new ButtonTouchListner(1, -1, 3, 2, 1, -1, chord));
